...
Game.Hanoi.prototype = 
{
    ...
    preload : function() {
        ...
        this.load.spritesheet('button', 'resources/game/buttonasset.png', 80, 40);
        this.load.bitmapFont('nokia', 'resources/fonts/nokia16black.png', 'resources/fonts/nokia16black.xml');

		this.load.spritesheet('tower', 'resources/game/tower2.png', 100, 600);
		
        this.load.spritesheet('pieceMorado', 'resources/game/morado.png', 60, 300);
		...
		this.load.spritesheet('pieceBlue', 'resources/game/blue2.png', 60, 300);
    ...
    create: function() {
		...
		//this._numberPiece = 6;
        this.game.stage.backgroundColor = "#ffe082";
		...
		var standar = [];
        var colors = ['pieceMorado', 'pieceViolet', 'pieceYellow', 'pieceBlue', 'pieceRojo', 'pieceBrown'];
    ...
    validateHanoi: function(p) {
        ...
        if (this.physics.arcade.overlap(p, this._towers, function(piece, tower) {
           ...
           if (this.winUser(this._towers.getAt(2)._pieces)) {
                ...
                var stWin  = this.add.text(320, 50, '¡Ha ganado!', style);
                stWin.fontSize = '33px';
...
// acá configuro las variables globales

var settings = 
    { 
        MinPieces: 3,
        MaxPieces: 7, 
        InitialSpeedSolve: 25, 
        MaxSpeedSolve: 10000, 
        IntervalIncrementSpeedSolve: 50 
    };

var game = new Phaser.Game(900, 700, Phaser.AUTO, 'hanoi-example');
